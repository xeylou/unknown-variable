...
export const messages = {
  ...
  'userinfo.field.mc': { en: '⛏️ Minecraft', fr: '⛏️ Minecraft' },
  ...
  'mclink.sub.statut.desc': { en: 'Check a link (yours, or a member/username for staff)', fr: 'Voir une liaison (la vôtre, ou un membre/pseudo pour le staff)' },
  'mclink.sub.delier.desc': { en: 'Unlink a username — keeps the whitelist (staff)', fr: 'Délier un pseudo — garde la whitelist (staff)' },
  'mclink.sub.forcer.desc': { en: 'Force-link a member to a username, no in-game check (staff)', fr: 'Forcer la liaison d\'un membre à un pseudo, sans validation en jeu (staff)' },
  ...
  'mclink.opt.statut_membre.desc': { en: 'Member whose link to check (staff)', fr: 'Membre dont voir la liaison (staff)' },
  'mclink.opt.statut_pseudo.desc': { en: 'Username to look up (who is linked to it — staff)', fr: 'Pseudo à rechercher (qui y est lié — staff)' },
  'mclink.opt.forcer_membre.desc': { en: 'Member to link', fr: 'Membre à lier' },
  'mclink.opt.forcer_pseudo.desc': { en: 'Minecraft username to link them to', fr: 'Pseudo Minecraft à lui lier' },
